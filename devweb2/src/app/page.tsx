    ...
    <div className="w-full min-h-screen bg-sky-500 flex justify-center items-center px-4 shadow-lg">
      <main className="my-10 w-full max-w-lg bg-white shadow-lg rounded-lg p-6">
        ...
        <form className="flex flex-col mb-6">
          ...
          <input
            type="text"
            className="w-full mb-4 p-3 rounded-md border border-sky-300 focus:outline-none focus:ring-2 focus:ring-sky-400"
        ...
        <h2 className="text-sky-800 font-semibold mb-2">Tarefas:</h2>
          {tasks.map( (task) => (
              <article className="w-full bg-sky-200 text-slate-800 p-2 rounded relative hover:bg-sky-300">
